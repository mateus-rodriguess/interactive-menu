...
SIMPLE_JWT = {
    ...
    'SLIDING_TOKEN_LIFETIME': timedelta(minutes=5) if not DEBUG else timedelta(days=10),
    'SLIDING_TOKEN_REFRESH_LIFETIME':  timedelta(days=1) if not DEBUG else timedelta(days=20),
}
