...
urlpatterns = [
    ...
    path("add/ingredient/", views.IngredientCreate.as_view(), name="ingredient_app"),
    ...
    path("item/ingredient/", views.ItemIngredientView.as_view(),
         name="item_ingredient_list"),
    path("item/ingredient/<pk>/", views.ItemIngredientDetailView.as_view(),
